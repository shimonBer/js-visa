...
/** CEAC confirmation PDF means autofill reached a successful DS-160 submission. */
export function hasDs160AutofillSuccess(s3Documents, formId) {
  return submittedPdfsFromDocuments(s3Documents, formId)
    .some((doc) => doc.field === DS160_CONFIRMATION_FIELD)
}
