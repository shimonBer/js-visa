...
/** Desktop autofill download: same name as the translation file, plus _auto_fill. */
export function autofillDownloadFileName(options) {
  return translatedDownloadFileName(options).replace(/\.txt$/i, '_auto_fill.txt')
}
